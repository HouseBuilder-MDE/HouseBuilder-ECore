 ...
 * <!-- end-user-doc -->
 * @see housebuilderV2.HousebuilderV2Package#getGroundType()
 * @model
 * @generated
 */
public enum GroundType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final GroundType[] VALUES_ARRAY =
		new GroundType[] {
			ASPALTH,
			TERRAIN,
			PAVING,
	...
	public static GroundType get(int value) {
		switch (value) {
			case ASPALTH_VALUE: return ASPALTH;
			case TERRAIN_VALUE: return TERRAIN;
