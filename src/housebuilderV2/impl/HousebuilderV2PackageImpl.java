...
import housebuilderV2.util.HousebuilderV2Validator;
 ...
 * @generated
 */
public class HousebuilderV2PackageImpl extends EPackageImpl implements HousebuilderV2Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see housebuilderV2.HousebuilderV2Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private HousebuilderV2PackageImpl() {
		super(eNS_URI, HousebuilderV2Factory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link HousebuilderV2Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static HousebuilderV2Package init() {
		if (isInited) return (HousebuilderV2Package)EPackage.Registry.INSTANCE.getEPackage(HousebuilderV2Package.eNS_URI);

		// Obtain or create and register package
		Object registeredHousebuilderV2Package = EPackage.Registry.INSTANCE.get(eNS_URI);
		HousebuilderV2PackageImpl theHousebuilderV2Package = registeredHousebuilderV2Package instanceof HousebuilderV2PackageImpl ? (HousebuilderV2PackageImpl)registeredHousebuilderV2Package : new HousebuilderV2PackageImpl();

		isInited = true;

		// Create package meta-data objects
		theHousebuilderV2Package.createPackageContents();

		// Initialize created meta-data
		theHousebuilderV2Package.initializePackageContents();

		// Register package validator
		EValidator.Registry.INSTANCE.put
			(theHousebuilderV2Package,
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return HousebuilderV2Validator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		theHousebuilderV2Package.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(HousebuilderV2Package.eNS_URI, theHousebuilderV2Package);
		return theHousebuilderV2Package;
	}
	 ...
	 * @generated
	 */
	public HousebuilderV2Factory getHousebuilderV2Factory() {
		return (HousebuilderV2Factory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getHouse_State(), ecorePackage.getEString(), "state", null, 0, 1, House.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHouse_Province(), ecorePackage.getEString(), "province", null, 0, 1, House.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHouse_City(), ecorePackage.getEString(), "city", null, 0, 1, House.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHouse_PostalCode(), ecorePackage.getEString(), "postalCode", null, 0, 1, House.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getHouse_BuildingDate(), ecorePackage.getEDate(), "buildingDate", null, 0, 1, House.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getHouse_Floors(), this.getFloor(), this.getFloor_House(), "floors", null, 1, -1, House.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getHouse_Passages(), this.getPassage(), this.getPassage_House(), "passages", null, 0, -1, House.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getHouse_Controllers(), this.getController(), this.getController_House(), "controllers", null, 0, -1, House.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHouse_InternalFootage(), ecorePackage.getEFloat(), "internalFootage", null, 1, 1, House.class, !IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getHouse_OuterFootage(), ecorePackage.getEFloat(), "outerFootage", null, 1, 1, House.class, !IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getHouse_Footage(), ecorePackage.getEFloat(), "footage", null, 1, 1, House.class, !IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getHouse_RoomsNumber(), ecorePackage.getEInt(), "roomsNumber", null, 1, 1, House.class, !IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getHouse_Entrances(), this.getEntrance(), this.getEntrance_House(), "entrances", null, 1, -1, House.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEOperation(getHouse__HasOuterSpace(), ecorePackage.getEBooleanObject(), "hasOuterSpace", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getFloor_Level(), ecorePackage.getEInt(), "level", null, 1, 1, Floor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFloor_Spaces(), this.getSpace(), this.getSpace_Floor(), "spaces", null, 1, -1, Floor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFloor_House(), this.getHouse(), this.getHouse_Floors(), "house", null, 1, 1, Floor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFloor_InternalFootage(), ecorePackage.getEFloat(), "internalFootage", null, 1, 1, Floor.class, !IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getFloor_OuterFootage(), ecorePackage.getEFloat(), "outerFootage", null, 1, 1, Floor.class, !IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getFloor_Footage(), ecorePackage.getEFloat(), "footage", null, 1, 1, Floor.class, !IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getFloor_RoomsNumber(), ecorePackage.getEInt(), "roomsNumber", null, 1, 1, Floor.class, !IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);

		initEClass(spaceEClass, Space.class, "Space", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSpace_Length(), ecorePackage.getEFloat(), "length", null, 1, 1, Space.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSpace_Width(), ecorePackage.getEFloat(), "width", null, 1, 1, Space.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRoom_Height(), ecorePackage.getEFloat(), "height", null, 1, 1, Room.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRoom_RoomType(), this.getRoomType(), "roomType", null, 0, 1, Room.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPassage_SpaceA(), this.getSpace(), this.getSpace_PassagesA(), "spaceA", null, 1, 1, Passage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPassage_SpaceB(), this.getSpace(), this.getSpace_PassagesB(), "spaceB", null, 1, 1, Passage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getController_Sensors(), this.getSensor(), this.getSensor_Controller(), "sensors", null, 1, -1, Controller.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDevice_Model(), ecorePackage.getEString(), "model", null, 0, 1, Device.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDevice_Actuator(), this.getActuator(), this.getActuator_Device(), "actuator", null, 0, 1, Device.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDevice_Space(), this.getSpace(), this.getSpace_Devices(), "space", null, 0, 1, Device.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDevice_Door(), this.getDoor(), this.getDoor_Devices(), "door", null, 0, 1, Device.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDoor_Devices(), this.getDevice(), this.getDevice_Door(), "devices", null, 0, -1, Door.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(entranceEClass, Entrance.class, "Entrance", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEntrance_House(), this.getHouse(), this.getHouse_Entrances(), "house", null, 1, 1, Entrance.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEntrance_Space(), this.getSpace(), this.getSpace_Entrances(), "space", null, 1, 1, Entrance.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (floorEClass,
		   source,
		   new String[] {
			   "constraints", "FloorLevelUnique"
		   });
		addAnnotation
		  (controllerEClass,
		   source,
		   new String[] {
			   "constraints", "OsVersionMissing"
		   });
		addAnnotation
		  (windowEClass,
		   source,
		   new String[] {
			   "constraints", "WindowHeightConstraints"
		   });
	}
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation
		  (getHouse__HasOuterSpace(),
		   source,
		   new String[] {
			   "body", "self.floors.spaces->select(e | e.oclIsTypeOf(ExternalSpace))->size() > 0"
		   });
		addAnnotation
		  (getHouse__IsSmart(),
		   source,
		   new String[] {
			   "body", "self.controllers->size() > 0"
		   });
		addAnnotation
		  (getHouse_InternalFootage(),
		   source,
		   new String[] {
			   "derivation", "self.floors->collect(s | s.internalFootage)->sum()"
		   });
		addAnnotation
		  (getHouse_OuterFootage(),
		   source,
		   new String[] {
			   "derivation", "self.floors->collect(s | s.outerFootage)->sum()"
		   });
		addAnnotation
		  (getHouse_Footage(),
		   source,
		   new String[] {
			   "derivation", "internalFootage + outerFootage"
		   });
		addAnnotation
		  (getHouse_RoomsNumber(),
		   source,
		   new String[] {
			   "derivation", "self.floors->collect(s | s.roomsNumber)->sum()"
		   });
		addAnnotation
		  (floorEClass,
		   source,
		   new String[] {
			   "FloorLevelUnique", "Tuple {\n\tmessage : String = \'There is another floor with the same level. Level must be unique\',\n\tstatus : Boolean = \n\t\t\t\t\t\t\tself.house.floors->select(f | f <> self)->collect(f | f.level)->excludes(self.level)\n}.status"
		   });
		addAnnotation
		  (getFloor_InternalFootage(),
		   source,
		   new String[] {
			   "derivation", "self.spaces->select(s | s.oclIsTypeOf(Room))->collect(s | s.footage)->sum()"
		   });
		addAnnotation
		  (getFloor_OuterFootage(),
		   source,
		   new String[] {
			   "derivation", "self.spaces->select(s | s.oclIsTypeOf(ExternalSpace))->collect(s | s.footage)->sum()"
		   });
		addAnnotation
		  (getFloor_Footage(),
		   source,
