 ...
 * <!-- end-user-doc -->
 * @see housebuilderV2.HousebuilderV2Package#getDoorType()
 * @model
 * @generated
 */
public enum DoorType implements Enumerator {
	...
	public static DoorType get(int value) {
		switch (value) {
			...
			case DOOR_WINDOW_VALUE: return DOOR_WINDOW;
			case PANIC_DOOR_VALUE: return PANIC_DOOR;
			case ENTRANCE_DOOR_VALUE: return ENTRANCE_DOOR;
			case SLIDING_DOOR_VALUE: return SLIDING_DOOR;
