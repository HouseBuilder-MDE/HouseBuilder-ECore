 ...
 * @generated
 */
public class HousebuilderV2Switch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case HousebuilderV2Package.HOUSE: {
				...
				if (result == null) result = caseNamed(house);
			...
			case HousebuilderV2Package.FLOOR: {
				...
				if (result == null) result = caseNamed(floor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HousebuilderV2Package.SPACE: {
				...
				if (result == null) result = caseNamed(space);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HousebuilderV2Package.ROOM: {
				...
				if (result == null) result = caseSpace(room);
				if (result == null) result = caseNamed(room);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HousebuilderV2Package.PASSAGE: {
				...
				if (result == null) result = caseDoor(passage);
				if (result == null) result = caseNamed(passage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case HousebuilderV2Package.ACTUATOR: {
				...
				if (result == null) result = caseNamed(actuator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case HousebuilderV2Package.DEVICE: {
				...
				if (result == null) result = caseNamed(device);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HousebuilderV2Package.WINDOW: {
				...
				if (result == null) result = caseNamed(window);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HousebuilderV2Package.EXTERNAL_SPACE: {
				...
				if (result == null) result = caseSpace(externalSpace);
				if (result == null) result = caseNamed(externalSpace);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HousebuilderV2Package.DOOR: {
				...
				if (result == null) result = caseNamed(door);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HousebuilderV2Package.ENTRANCE: {
				...
				if (result == null) result = caseDoor(entrance);
				if (result == null) result = caseNamed(entrance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
