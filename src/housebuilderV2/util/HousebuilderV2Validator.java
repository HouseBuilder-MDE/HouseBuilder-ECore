 ...
 * @generated
 */
public class HousebuilderV2Validator extends EObjectValidator {
	/**
	 ...
	 * @generated
	 */
	public static final HousebuilderV2Validator INSTANCE = new HousebuilderV2Validator();
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "housebuilderV2";
	 ...
	 * @generated
	 */
	public HousebuilderV2Validator() {
		super();
	}
	...
	protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
		switch (classifierID) {
			...
			case HousebuilderV2Package.NAMED:
			...
			case HousebuilderV2Package.SPACE:
			...
			case HousebuilderV2Package.DOOR:
	...
	public boolean validateFloor(Floor floor, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateFloor_FloorLevelUnique(floor, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateFloor_FloorLevelUnique(Floor floor, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(HousebuilderV2Package.Literals.FLOOR,
				 floor,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 "FloorLevelUnique",
				 FLOOR__FLOOR_LEVEL_UNIQUE__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
	...
	public boolean validateController(Controller controller, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateController_OsVersionMissing(controller, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateController_OsVersionMissing(Controller controller, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(HousebuilderV2Package.Literals.CONTROLLER,
				 controller,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 "OsVersionMissing",
				 CONTROLLER__OS_VERSION_MISSING__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
	...
	public boolean validateWindow(Window window, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateWindow_WindowHeightConstraints(window, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateWindow_WindowHeightConstraints(Window window, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(HousebuilderV2Package.Literals.WINDOW,
				 window,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 "WindowHeightConstraints",
				 WINDOW__WINDOW_HEIGHT_CONSTRAINTS__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
	 ...
	 * @generated
	 */
	public boolean validateExternalSpace(ExternalSpace externalSpace, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateActuatorType(ActuatorType actuatorType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return true;
	}
