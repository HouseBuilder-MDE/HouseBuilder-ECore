 ...
 * <!-- end-user-doc -->
 * @see housebuilderV2.HousebuilderV2Package#getSensorType()
 * @model
 * @generated
 */
public enum SensorType implements Enumerator {
	...
	public static SensorType get(int value) {
		switch (value) {
			...
			case PROXIMITY_VALUE: return PROXIMITY;
			case ACCELEROMETER_VALUE: return ACCELEROMETER;
			case GAS_VALUE: return GAS;
			case SMOKE_VALUE: return SMOKE;
			case VIDEO_SURVAILLANCE_CAMERA_VALUE: return VIDEO_SURVAILLANCE_CAMERA;
		}
		return null;
	}
