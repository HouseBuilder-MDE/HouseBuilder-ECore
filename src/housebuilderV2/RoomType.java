 ...
 * <!-- end-user-doc -->
 * @see housebuilderV2.HousebuilderV2Package#getRoomType()
 * @model
 * @generated
 */
public enum RoomType implements Enumerator {
	...
	public static RoomType get(int value) {
		switch (value) {
			...
			case BATHROOM_VALUE: return BATHROOM;
			case LIVING_ROOM_VALUE: return LIVING_ROOM;
			case BEDROOM_VALUE: return BEDROOM;
			case HALLWAY_VALUE: return HALLWAY;
			case STUDY_VALUE: return STUDY;
			case ENTRANCE_VALUE: return ENTRANCE;
			case STORAGE_ROOM_VALUE: return STORAGE_ROOM;
			case GARAGE_VALUE: return GARAGE;
			case LAUNDRY_ROOM_VALUE: return LAUNDRY_ROOM;
			case HOBBY_ROOM_VALUE: return HOBBY_ROOM;
			case CELLAR_VALUE: return CELLAR;
			case LUNCHROOM_VALUE: return LUNCHROOM;
			case RUMPUS_ROOM_VALUE: return RUMPUS_ROOM;
			case STAIRS_VALUE: return STAIRS;
			case KITCHEN_VALUE: return KITCHEN;
		}
		return null;
	}
